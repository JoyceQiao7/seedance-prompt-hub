    ...
    <div className="shell">
      ...
      <footer className="hint">
        <p>
          ...
          pulls recent X posts that match Seedance-related queries, extracts prompts, scores them,
          optionally refines them with OpenAI, then commits <span className="mono">data/prompts.json</span>.
          This site is a static build from that file.
        </p>
        <p style={{ marginTop: "0.75rem" }}>
          You need an X Developer Project with <span className="mono">TWITTER_BEARER_TOKEN</span>{" "}
          (recent search). <span className="mono">OPENAI_API_KEY</span> is optional but improves
